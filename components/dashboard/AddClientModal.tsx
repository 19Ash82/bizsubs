// Updated 2024-12-20: AddClientModal with React Hook Form and Zod validation
...
import { useCreateClient, type CreateClientData } from '@/lib/react-query/clients';
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new client to organize your subscriptions and track costs.
          </DialogDescription>
        </DialogHeader>
            ...
            <FormField
              ...
              render={({ field }) => (
                <FormItem>
                  ...
                  <Select onValueChange={field.onChange} defaultValue={field.value} disabled={createClientMutation.isPending}>
                    <FormControl>
                      <SelectTrigger>
